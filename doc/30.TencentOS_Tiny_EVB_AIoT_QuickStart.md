...
1M RAM ，32M SDRAM、32M QSPI Flash
...
完成编译后，在工程上右键选择调试方式，再选择CMSIS-DAP（开发板板载了CMSIS DAP调试器）进行工程下载和调试，如下图：
...
## 3. 在EVB_AIoT开发板上移植TencentOS tiny内核 
...
## 4. EVB_AIoT开发板上使用TencentOS tiny对接腾讯云IoT Explorer
