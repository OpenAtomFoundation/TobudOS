...
+ 创建并实现云函数
  + 创建云函数query，将自动生成的NodeJS代码拷贝到云函数，并稍作修改即可使用。参考：[TencentOS-tiny\tools\Mini_Program\iotexplorer_mp_cloudfunctions_demo\cloudfunctions\query\index.js](https://github.com/OpenAtomFoundation/TencentOS-tiny/tree/develop/tools/Mini_Program/iotexplorer_mp_cloudfunctions_demo/cloudfunctions/query/index.js)

  + 记得上传部署修改后的云函数

+ 调用云函数
  + 调用云函数的代码也很简单。参考：[TencentOS-tiny\tools\Mini_Program\iotexplorer_mp_cloudfunctions_demo\miniprogram\pages\index\index.js#queryDeviceData()](https://github.com/OpenAtomFoundation/TencentOS-tiny/tree/develop/tools/Mini_Program/iotexplorer_mp_cloudfunctions_demo/miniprogram/pages/index/index.js)
