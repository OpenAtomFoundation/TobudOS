...
typedef enum IRQn {
  ...
  FTM0_IRQn                    = 42,               /**< FTM0 fault, overflow and chls interrupt */
  FTM1_IRQn                    = 43,               /**< FTM1 fault, overflow and chls interrupt */
  FTM2_IRQn                    = 44,               /**< FTM2 fault, overflow and chls interrupt */
  CMT_IRQn                     = 45,               /**< CMT interrupt */
  RTC_IRQn                     = 46,               /**< RTC interrupt */
  RTC_Seconds_IRQn             = 47,               /**< RTC seconds interrupt */
  PIT0_IRQn                    = 48,               /**< PIT timer chl 0 interrupt */
  PIT1_IRQn                    = 49,               /**< PIT timer chl 1 interrupt */
  PIT2_IRQn                    = 50,               /**< PIT timer chl 2 interrupt */
  PIT3_IRQn                    = 51,               /**< PIT timer chl 3 interrupt */
  ...
  FTM3_IRQn                    = 71,               /**< FTM3 fault, overflow and chls interrupt */
