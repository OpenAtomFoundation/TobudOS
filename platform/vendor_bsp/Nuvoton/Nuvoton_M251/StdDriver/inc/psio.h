...
#define PSIO_SLOT0          0x00000000UL            /*!<PSIO Slot 0  \hideinitializer */
#define PSIO_SLOT1          0x00000001UL            /*!<PSIO Slot 1  \hideinitializer */
#define PSIO_SLOT2          0x00000002UL            /*!<PSIO Slot 2  \hideinitializer */
#define PSIO_SLOT3          0x00000003UL            /*!<PSIO Slot 3  \hideinitializer */
#define PSIO_SLOT4          0x00000004UL            /*!<PSIO Slot 4  \hideinitializer */
#define PSIO_SLOT5          0x00000005UL            /*!<PSIO Slot 5  \hideinitializer */
#define PSIO_SLOT6          0x00000006UL            /*!<PSIO Slot 6  \hideinitializer */
#define PSIO_SLOT7          0x00000007UL            /*!<PSIO Slot 7  \hideinitializer */
...
#define PSIO_PIN_ENABLE     0x00000001UL            /*!<PSIO Enable   \hideinitializer */
#define PSIO_PIN_DISABLE    0x00000000UL            /*!<PSIO Disable  \hideinitializer */
...
#define PSIO_SCSLOT_SET_SLOT(psio, u32SC, u32Slot, u32Cnt) ((psio)->SCCT[(u32SC)].SCSLOT= \
        ((psio)->SCCT[(u32SC)].SCSLOT & ~(PSIO_SCCT_SCSLOT_SLOT0CNT_Msk<<((u32Slot)*PSIO_SCCT_SCSLOT_SLOT1CNT_Pos)))|((u32Cnt&0xF)<<((u32Slot)*PSIO_SCCT_SCSLOT_SLOT1CNT_Pos)))
...
#define PSIO_SET_CHECKPOINT(psio, u32Pin, u32CheckPoint, u32Slot) (psio->GNCT[(u32Pin)].CPCTL0= \
        ...
        |(((u32Slot)+1)<<((u32CheckPoint)*PSIO_GNCT_CPCTL0_CKPT1_Pos)))
...
__STATIC_INLINE void PSIO_SET_INTCTL(PSIO_T *psio, uint32_t u32SC, uint32_t u32Int, uint32_t u32Slot)
{
    if (u32Int == PSIO_INT0)
    {
        (psio)->INTCTL = (((psio)->INTCTL & ~PSIO_INTCTL_CONI0SS_Msk & ~PSIO_INTCTL_CONI0SCS_Msk)
                          ...
                          | ((u32Slot + 1) << PSIO_INTCTL_CONI0SS_Pos));
    }
    else if (u32Int == PSIO_INT1)
    {
        (psio)->INTCTL = (((psio)->INTCTL & ~PSIO_INTCTL_CONI1SS_Msk & ~PSIO_INTCTL_CONI1SCS_Msk)
                          ...
                          | ((u32Slot + 1) << PSIO_INTCTL_CONI1SS_Pos));
    }
}
...
__STATIC_INLINE void PSIO_SET_SCCTL(PSIO_T *psio, uint32_t u32SC, uint32_t u32InitSlot, uint32_t u32EndSlot, uint32_t u32LoopCnt, uint32_t u32Repeat)
{
    (psio)->SCCT[u32SC].SCCTL = ((psio)->SCCT[u32SC].SCCTL & ~PSIO_SCCT_SCCTL_INISLOT_Msk & ~PSIO_SCCT_SCCTL_ENDSLOT_Msk & ~PSIO_SCCT_SCCTL_SPLCNT_Msk)
                                | ((u32InitSlot + 1) << PSIO_SCCT_SCCTL_INISLOT_Pos)
                                | ((u32EndSlot + 1) << PSIO_SCCT_SCCTL_ENDSLOT_Pos)
