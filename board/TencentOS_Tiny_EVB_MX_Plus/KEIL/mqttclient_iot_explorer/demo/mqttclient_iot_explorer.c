...
void mqttclient_task(void)
{
    ...
    esp8266_join_ap("Supowang", "wang13975426138");
#endif
    ...
    tos_sal_module_parse_domain("TCC64FUFGD.iotcloud.tencentdevices.com",host_ip,sizeof(host_ip));
    ...
    */
    ...
    mqtt_set_client_id(client, "TCC64FUFGDsupowang");
    mqtt_set_user_name(client, "TCC64FUFGDsupowang;21010406;12365;4294967295");
    mqtt_set_password(client, "f7ab801d3119ad21bdd3f409c8be3c20bbf2a2b7;hmacsha1");
    ...
    error = mqtt_subscribe(client, "$thing/down/property/TCC64FUFGD/supowang", QOS0, tos_topic_handler);
    ...
    while (1) {
        ...
        error = mqtt_publish(client, "$thing/up/property/TCC64FUFGD/supowang", &msg);
