...
/**
 * @brief …Ë±∏”∞◊”Œƒµµ≤Ÿ◊˜œ‡πÿµƒ“ª–©Ω”ø⁄
 *
 * ’‚¿ÔÃ·π©“ª–©Ω”ø⁄”√”⁄π‹¿Ì…Ë±∏”∞◊”ŒƒµµªÚ”Î…Ë±∏”∞◊”ŒƒµµΩ¯––Ωªª•; Õ®π˝DeviceName,
 * ø…“‘”Î…Ë±∏”∞◊”Ω¯––Ωªª•, ∞¸¿®µ±«∞…Ë±∏µƒ…Ë±∏”∞◊”∫Õ∆‰À˚…Ë±∏µƒ…Ë±∏”∞◊”; “ª
 * ∏ˆ…Ë±∏“ªπ≤”–»˝÷÷≤ªÕ¨≤Ÿ◊˜”Î…Ë±∏”∞◊”Ωªª•:
 *     1. Get
 *     2. Update
 *     3. Delete
 *
 * “‘…œ»˝÷÷≤Ÿ◊˜, µ◊≤„ªπ «ª˘”⁄MQTT–≠“È, π§◊˜‘≠¿Ì“≤ «ª˘”⁄∑¢≤º/∂©‘ƒƒ£–Õ, µ±÷¥––
 * …œ ˆ≤Ÿ◊˜ «, ª· ’µΩœ‡”¶µƒœÏ”¶: 1. accepted; 2. rejected°£¿˝»Á, Œ“√«÷¥––
 * Get”Î…Ë±∏”∞◊”Ω¯––Ωªª•, …Ë±∏∂ÀΩ´∑¢ÀÕ∫ÕΩ” ’µΩ“ªœ¬–≈œ¢:
 *     1. ∑¢≤ºMQTT÷˜Ã‚: $shadow/get/{productName}/{deviceName};
 *     2. ∂©‘ƒMQTT÷˜Ã‚: $shadow/get/accepted/{productName}/{deviceName} ∫Õ $shadow/get/rejected/{productName}/{deviceName}
 *     3. »Áπ˚’˚∏ˆ«Î«Û≥…π¶µƒª∞, …Ë±∏∂Àª· ’µΩaccepted÷˜Ã‚, “‘º∞œ‡”¶…Ë±∏µƒjsonŒƒµµ°£
 */
...
/**
 * @brief ËÆæÂ§áÂ±ûÊÄßÂ§ÑÁêÜÂõûË∞ÉÂáΩÊï∞
 *
 * @param pJsonValueBuffer ËÆæÂ§áÂ±ûÊÄßÂÄº
 * @param valueLength      ËÆæÂ§áÂ±ûÊÄßÂÄºÈïøÂ∫¶
 * @param DeviceProperty   ËÆæÂ§áÂ±ûÊÄßÁªìÊûÑ‰Ωì
 */
...
/**
 * @brief ÊØèÊ¨°ÊñáÊ°£ËØ∑Ê±ÇÂìçÂ∫îÁöÑÂõûË∞ÉÂáΩÊï∞
 *
 * @param method         ÊñáÊ°£Êìç‰ΩúÊñπÂºè
 * @param requestAck     ËØ∑Ê±ÇÂìçÂ∫îÁ±ªÂûã
 * @param pJsonDocument  ‰∫ëÁ´ØÂìçÂ∫îËøîÂõûÁöÑÊñáÊ°£
 * @param userContext      Áî®Êà∑Êï∞ÊçÆ
 *
 */
